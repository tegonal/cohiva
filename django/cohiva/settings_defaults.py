...
MIDDLEWARE += (
    ...
    # AuditlogMiddleware must be after AuthenticationMiddleware to capture the actor/user
        ...
        "items": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {"type": "model", "value": "geno.RentalUnitWeight"},
                    {"type": "model", "value": "geno.RentalUnitWeightType"},
                ],
            },
        ],
    },
