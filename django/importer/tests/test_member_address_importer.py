...
from importer.member_address_importer import MemberAddressImporter
from importer.models import ImportJob

User = get_user_model()


class MemberAddressImporterTest(TestCase):
    """Test the Member/Address importer."""
    ...
    def create_test_excel(self, rows):
        ...
        # Headers
        headers = [
            "email", "____Person", "X_heute", "P_nr", "____Adressangaben",
            "P_ansprechperson", "P_co", "P_strasse", "P_postfach", "P_plzort",
            "P_geschlecht", "P_anrede", "P_land", "P_titel", "P_briefanrede",
            "____Kontakt", "P_nachname", "P_vorname", "P_telp", "P_telg",
            "P_faxp", "P_faxg", "P_mobilep", "P_mobileg", "P_emailp", "P_emailg",
            "P_homepagep", "P_homepageg", "____Persönliches", "P_beruf",
            "P_arbeitgeber", "P_heimatort", "P_geburtsort", "P_geburtsdatum",
            "P_portalregcode", "P_portalurllogin", "____Zahlstellen", "ZS_dd",
            "ZS_kontoinhaberdd", "ZS_lsv", "ZS_kontoinhaberlsv",
            "ZS_auszahlungnk", "ZS_kontoinhaberauszahlungnk",
    ...
    def test_import_simple_person(self):
        ...
        rows = [
            [
                ...
                "", "2024-01-15", "1001", "",  # Person section + join date + P_nr
                "", "", "Teststrasse 42", "", "3011 Bern",  # Address
                "Herr", "Herr", "Schweiz", "", "",  # Title/salutation
                "", "Müller", "Max", "+41 31 123 45 67", "",  # Contact - name
                "", "", "+41 79 123 45 67", "", "max.test@example.com", "",  # Contact - phones/email
                "", "", "", "Informatiker",  # Contact - web, Personal - occupation (P_beruf)
                "Tech AG", "Bern", "", "1990-05-15",  # P_arbeitgeber, Personal info
        ...
        # Process import
        importer = MemberAddressImporter(import_job)
        ...
        self.assertEqual(address.occupation, "Informatiker, Tech AG")  # Combined P_beruf + P_arbeitgeber
    ...
    def test_import_organization(self):
        ...
        rows = [
            [
                "kontakt@example.ch",
                "", "", "1002", "",
                "Example GmbH", "", "Hauptstrasse 100", "Postfach 1234", "4000 Basel",
                "Firma", "Firma", "Schweiz", "", "",
                "", "Weber", "Thomas", "+41 61 123 45 67", "",
                "", "", "", "", "kontakt@example.ch", "",
                "", "", "", "",
                "", "", "", "",
                "", "", "", "",
    ...
    def test_import_with_bank_account(self):
        ...
        self.assertEqual(address.bankaccount.iban, "CH9300762011623852957")  # Normalized IBAN (spaces removed)
    ...
    def test_update_existing_address(self):
        ...
        import_job_existing = ImportJob.objects.create(
            file=excel_file_temp,
            created_by=self.user
        )
        ...
        rows = [
            [
                "new@example.com",
                "", "", "1004", "",  # Same P_nr -> same import_id when using same job
                "", "", "Newstrasse 99", "", "8000 Zürich",
                "Herr", "Herr", "Schweiz", "", "",
                "", "NewName", "NewFirst", "", "",
                "", "", "", "", "new@example.com", "",
                "", "", "", "",
        ...
        importer = MemberAddressImporter(import_job_existing)
        results = importer.process()
    ...
    def test_missing_required_fields(self):
        ...
        self.assertIn("Mindestens Vor- oder Nachname erforderlich",
