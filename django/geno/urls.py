...
urlpatterns = [
    ...
    path("share/overview/", geno_views.share_overview),
    ...
    path("member/check_mailinglists/", geno_views.check_mailinglists),
    ...
    path("address/export/", geno_views.address_export),
