...
class Migration(migrations.Migration):
    dependencies = [
        ("geno", "0030_rename_and_add_share_fields"),
    ]
...
SELECT DISTINCT
    ...
    c.ts_modified
FROM
    (select ctmp.id as id, ctmp.ts_created as ts_created, ctmp.ts_modified as ts_modified, 0 as isSC, ctmp.active as active from geno_contract ctmp UNION select sctmp.id as id, sctmp.ts_created as ts_created, sctmp.ts_modified as ts_modified, 1 as isSC, sctmp.active as active from geno_contract ctmp JOIN geno_contract sctmp ON ctmp.id = sctmp.main_contract_id) as c
LEFT JOIN
