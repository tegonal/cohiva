    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finanzinstitut', models.CharField(blank=True, max_length=100, verbose_name='Finanzinstitut')),
                ('kontoinhaber', models.CharField(blank=True, max_length=100, verbose_name='Kontoinhaber')),
            ],
            options={
                'abstract': False,
            },
